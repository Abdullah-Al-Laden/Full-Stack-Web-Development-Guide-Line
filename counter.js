var _statcounter = (function (_1) {
  ...
  try {
        ...
        try {
          if (typeof performance !== "undefined") {
            ...
            for (var i = 0; i < _34.length; i++) {
              var _36 = _34[i];
              if (
                _36.name.includes("statcounter.com/counter/counter.js") ||
                _36.name.includes("statcounter.com/counter/counter_test.js")
              ) {
                _31 =
                  "&sc_rum_f_s=" +
                  Math.round(_36.requestStart) +
                  "&sc_rum_f_e=" +
                  Math.round(_36.responseEnd);
                break;
              }
            }
          }
    ...
    function strip_tags(_43, _44) {
      _44 = (
        ((_44 || "") + "").toLowerCase().match(/<[a-z][a-z0-9]*>/g) || []
      ).join("");
      ...
      if (_53(_52, "tags") && typeof _52.tags === "object") {
        ...
        if (validate_tags(_5a)) {
          ...
          for (var i = 0; i < _5a.length; i = i + 2) {
            _59["sc_ev_" + encodeURIComponent(_5a[i])] = encodeURIComponent(
              _5a[i + 1]
            );
          }
        }
    ...
    var _66 = function (_67, _68) {
      ...
      var _6a = mixkey(
        flatten(
          _68 ? [_67, tostring(_5d)] : 0 in arguments ? _67 : autoseed(),
          3
        ),
        key
      );
    ...
    function detectBrowserFeatures() {
      ...
      var _89 = new RegExp("Mac OS X.*Safari/").test(navigator.userAgent)
    ...
    function _writeCookie(_b0, _b1, _b2, _b3, _b4) {
      ...
      _25.cookie =
        "sc_" + _b0 + "=" + _b1 + _b6 + "; domain=" + _b2 + "; path=/" + _b9;
    ...
    function config_ping(_d6, _d7, _d8) {
      _4.get_config(_d7, function (_d9) {
        ...
        var suc = _sessionStorageSetConfig(
          "sc_project_time_difference_" + _d6,
          parseInt(_d9["time_difference"])
        );
        if (suc) {
          _21 = "true";
        } else {
    ...
    function check_root_domains_match(a, b) {
      ...
      if (
        ...
        ((_e0[_e0.length - 2].length <= 3 &&
          ...
          _e0[_e0.length - 1] == "ru" ||
          (_e0[_e0.length - 1] == "au" &&
            _e0[_e0.length - 2] in { csiro: 1 }) ||
          (_e0[_e0.length - 1] == "at" && _e0[_e0.length - 2] in { priv: 1 }) ||
          (_e0[_e0.length - 1] == "fr" &&
            _e0[_e0.length - 2] in
          ...
          (_e0[_e0.length - 1] == "il" && _e0[_e0.length - 2] in { muni: 1 }) ||
          (_e0[_e0.length - 1] == "za" &&
            _e0[_e0.length - 2] in { school: 1 }) ||
          (_e0[_e0.length - 1] == "tr" && _e0[_e0.length - 2] in { name: 1 }) ||
          (_e0[_e0.length - 1] == "uk" && _e0[_e0.length - 2] in { police: 1 }))
      ) {
        _e3 = 3;
      }
      for (var i = 1; i <= _e2; i++) {
      ...
      if (_f4 == 1) {
        ...
        if (_25.webkitVisibilityState == "prerender") {
          if (_5 == 1) {
            ...
            _25.addEventListener(
              "webkitvisibilitychange",
              delayed_send_pageview,
              false
            );
          }
          gen_counter(_f1, _f3, false, {}, { p: 1 });
        } else {
          if (_f5 == "[pending]") {
            setTimeout(function () {
              send_pageview(_f1, _f3, { p: 0, pv: _f5 });
            }, 1);
          } else {
            send_pageview(_f1, _f3, { p: 0 });
          }
        }
      }
    };
      ...
      if (_10 != "disabled") {
        ...
        try {
          ...
          if (!apply_new_methodology_fixes(_fd)) {
            if (
              rcat == "r" &&
              sessionStorage.getItem("statcounter_exit_domain") == rdom
            ) {
              rdom = "internal";
            }
          }
        ...
        if (_111["session_incremented"]) {
          ...
          if (_112 && !_112.match(/(^test$|wsdev$|^dev[0-9]*)/)) {
            _101 = true;
            _sessionStorageSetConfig(
              "sc_project_time_difference_" + _fd,
              false
            );
          }
        }
    ...
    function gen_counter(_115, mode, _117, _118, _119) {
      ...
      if (mode == "invisible") {
        ...
        if (mode == "text") {
          ...
          if (_117) {
            safer_writeln(
              '<span class="statcounter" id="' + _135 + '"></span>',
              _115
            );
          ...
          if (_117) {
            ...
            safer_writeln(
              '<span class="statcounter">' +
                _139 +
                generateCounterImageHtml(_133.replace(/&/g, "&amp;")) +
                _13a +
                "</span>",
              _115
            );
          ...
          if (_151.length > 0) {
            ...
            if (_4._add_recording_event) {
              _4._add_recording_event(
                _150 == 1 ? "download" : _150 == 2 ? "exit" : "unknown",
                { link: unescape(_151) }
              );
            }
            sc_delay();
    ...
    function sc_adsense_click(_15c, _15d) {
      ...
      if (_4._add_recording_event) {
        _4._add_recording_event("adsense", { link: unescape(_15e) });
      }
    }
      ...
      if (typeof e.pageX == "number") {
        ...
        if (typeof e.clientX == "number") {
          ...
          if (_25.body && (_25.body.scrollLeft || _25.body.scrollTop)) {
            ...
            if (
              _25.documentElement &&
              (_25.documentElement.scrollLeft || _25.documentElement.scrollTop)
            ) {
    ...
    function detect_dynamically_created_anchors(cdoc) {
      ...
      if (_183) {
        try {
            ...
            try {
              if (_187.tagName.toLowerCase() == "a") {
                ...
                if (_187.tagName.toLowerCase() == "area") {
                  if (
                    typeof _187.hasAttribute === "function" &&
                    _187.hasAttribute("href")
                  ) {
                    sc_process_anchor(_187);
                  }
                }
          ...
          _189.observe(cdoc.body, { subtree: true, childList: true });
        } catch (ei) {}
      }
    }
    function initiate_click_detection(cdoc) {
      ...
      for (var i = 0; i < _190.length; i++) {
        var _192 = _190[i];
        if (
          typeof _192.hasAttribute === "function" &&
          _192.hasAttribute("href")
        ) {
          sc_process_anchor(_192);
        }
      }
          ...
          if (parseInt(_1a2[0], 10) == _194) {
            ...
            _19d.push(
              "" +
                ...
                _f +
                "." +
                _4._returning_values[_194].join(".")
            );
          } else {
            _19d.push(_19c[i]);
    ...
    _4.get_session_num = function (_1ac) {
      ...
      if (
        _1ad != false &&
        _4._session_increment_calculated[_1ac] &&
        _4._returning_values[_1ac].length == _1f.length
      ) {
      ...
      if (_1ad === null) {
        ...
        if (!_4._session_increment_calculated[_1ac]) {
          return (
            "x-no-session-num-98" + Math.round(1000 * Math.random()) + _1af
          );
        } else {
          if (_4._returning_values[_1ac].length !== _1f.length) {
            return (
              "x-no-session-num-97" + Math.round(1000 * Math.random()) + _1af
            );
          } else {
            if (_1ad == false) {
              return (
                "x-no-session-num-96" + Math.round(1000 * Math.random()) + _1af
              );
            }
          }
        }
          ...
          var _1b9 = new MutationObserver(function () {
            ...
            if (_25.title != _1b7 && _1ba != _1b8) {
              for (var _1bb in _4._security_codes) {
                ...
                if (
                  _fc[_1bc] === undefined ||
                  new Date().getTime() - _fc[_1bc] > 1000
                ) {
                  setTimeout(
                    function (_1bd) {
                      if (
                        _fc[_1bd] === undefined ||
                        new Date().getTime() - _fc[_1bd] > 1000
                      ) {
                        if (_24.sc_top_reg !== undefined) {
    ...
    if (_2 != false && is_admin_project(_2)) {
      ...
      _1c1.src =
        ...
        encodeURIComponent(
          _25.location.protocol +
            "//" +
            _25.location.host +
            _25.location.pathname +
            _25.location.search +
            _25.location.hash
        ) +
